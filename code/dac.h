...
typedef ap_fixed<9, 4, AP_RND, AP_SAT> wt_type;//weight type
typedef ap_fixed<9, 4, AP_RND, AP_SAT> fm_type;//feature map data type
typedef ap_fixed<9, 4, AP_RND, AP_SAT> bs_type;//bias type
